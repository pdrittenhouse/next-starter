 ...
 *
 *   src/scss/printing/01-atoms/svg/generated/_icons-generated.scss
 *     The $sprites / $svgicon-sizes / $svgicon-variables maps and the sprite()
 *     mixin, for icons drawn as background-image data URIs rather than <use>.
 *     Generated by the WP theme build, so it only appears in the response once
 *     that has run.
 *
